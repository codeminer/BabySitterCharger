...
namespace BabySitterCharge
{
    public class BabySitter
    {
        ...
        public double getPayCharge(string bedTime, string startTime, string endTime)
        {
        ...
        protected int StartTimeToBedTimeCharge(int startTimeToBedTimeHOurs)
        {
            int rate;
            rate = 12;
        ...
        protected int BedTimeToMidnightCharge(int bedTimeToMidNightHours)
        {
            int timeDiff;
            int rate;

            timeDiff = 12 - bedTimeToMidNightHours;
            rate = 8;
            return bedTimeToMidNightHours * rate;
        }
        protected int MidnightToEndTimeCharge(int midNightToEndTimeHOurs)
        {
           int rate = 16;
